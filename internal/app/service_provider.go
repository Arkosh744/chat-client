...
import (
	...
	"github.com/Arkosh744/chat-client/internal/closer"
	"github.com/Arkosh744/chat-client/internal/handler"
	"github.com/Arkosh744/chat-client/internal/interceptor"
...
func (s *ServiceProvider) GetChatClient(ctx context.Context) chatServer.Client {
	if s.chatServerClient == nil {
		...
		// for testing purposes it is 1 minute, but can be set to 14 minutes (the token expires in 15 minutes)
		authInterceptor.Run(1 * time.Minute)
